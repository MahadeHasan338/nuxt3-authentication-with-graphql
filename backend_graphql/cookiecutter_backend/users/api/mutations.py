...
from cookiecutter_backend.users.api.inputs import CreateOrUpdateUserInput
from cookiecutter_backend.users.api.schema import UserObjectType
from cookiecutter_backend.users.tasks import send_password_reset_email, send_password_reset_otp
